...
class hasilconvertmatauangWON extends StatefulWidget {
  const hasilconvertmatauangWON({Key? key,}) : super(key: key);
  @override
  _hasilconvertmatauangWONState createState() => _hasilconvertmatauangWONState();
}

class _hasilconvertmatauangWONState extends State<hasilconvertmatauangWON> {
  ...
  Widget _buildDetailCardBody() {
    return Container(
      child: FutureBuilder(
        future: ConvertDataSource.instance.loadConvertWON(),
        builder: (
