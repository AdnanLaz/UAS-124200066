...
class hasilconvertmatauangMYR extends StatefulWidget {
  const hasilconvertmatauangMYR({Key? key,}) : super(key: key);
  @override
  _hasilconvertmatauangMYRState createState() => _hasilconvertmatauangMYRState();
}

class _hasilconvertmatauangMYRState extends State<hasilconvertmatauangMYR> {
  ...
  Widget _buildDetailCardBody() {
    return Container(
      child: FutureBuilder(
        future: ConvertDataSource.instance.loadConvertMYR(),
        builder: (
