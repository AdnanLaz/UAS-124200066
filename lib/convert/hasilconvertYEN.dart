...
class hasilconvertmatauangYEN extends StatefulWidget {
  const hasilconvertmatauangYEN({Key? key,}) : super(key: key);
  @override
  _hasilconvertmatauangYENState createState() => _hasilconvertmatauangYENState();
}

class _hasilconvertmatauangYENState extends State<hasilconvertmatauangYEN> {
  ...
  Widget _buildDetailCardBody() {
    return Container(
      child: FutureBuilder(
        future: ConvertDataSource.instance.loadConvertYEN(),
        builder: (
