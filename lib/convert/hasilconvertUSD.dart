...
class hasilconvertmatauangUSD extends StatefulWidget {
  const hasilconvertmatauangUSD({Key? key,}) : super(key: key);
  @override
  _hasilconvertmatauangUSDState createState() => _hasilconvertmatauangUSDState();
}

class _hasilconvertmatauangUSDState extends State<hasilconvertmatauangUSD> {
  ...
  Widget _buildDetailCardBody() {
    return Container(
      child: FutureBuilder(
        future: ConvertDataSource.instance.loadConvertUSD(),
        builder: (
