...
class hasilconvertmatauangTHB extends StatefulWidget {
  const hasilconvertmatauangTHB({Key? key,}) : super(key: key);
  @override
  _hasilconvertmatauangTHBState createState() => _hasilconvertmatauangTHBState();
}

class _hasilconvertmatauangTHBState extends State<hasilconvertmatauangTHB> {
  ...
  Widget _buildDetailCardBody() {
    return Container(
      child: FutureBuilder(
        future: ConvertDataSource.instance.loadConvertTHB(),
        builder: (
